// src/screens/TaskCompletionHistoryScreen.tsx - Dark Mode Added
        ...
        {showTaskDropdown && (
          <View style={[styles.dropdownMenu, { backgroundColor: theme.card, borderColor: theme.border, shadowColor: theme.shadow }]}>
            ...
            <ScrollView style={styles.dropdownList} nestedScrollEnabled>
              ...
              >
                <Text style={[styles.dropdownItemText, { color: theme.text }]}>All Tasks</Text>
              </TouchableOpacity>
              {filteredTasks.map(task => (
                ...
                >
                  <Text style={[styles.dropdownItemText, { color: theme.text }]} numberOfLines={1}>
                    {task.title}
                  </Text>
                </TouchableOpacity>
              ))}
    ...
    return historyData.tasks.map((taskGroup: any) => (
      ...
      >
        <View style={[styles.taskGroupHeader, { borderBottomColor: theme.border }]}>
          ...
          <Text style={[styles.taskGroupTitle, { color: theme.text }]}>{taskGroup.taskTitle}</Text>
          <LinearGradient
            ...
            >
              <View style={styles.completionHeader}>
                <View style={styles.userInfo}>
                  ...
                  <View style={styles.userDetails}>
                    <Text style={[styles.userName, { color: theme.text }]}>{completion.userName}</Text>
                ...
                <View style={styles.completionMeta}>
                  ...
                  >
                    <Text style={[
                      ...
                      { color: completion.week === selectedWeek ? '#fff' : theme.primary }
                    ]}>
              ...
              <View style={styles.completionDetails}>
                <View style={styles.detailRow}>
                  ...
                  <Text style={[styles.detailText, { color: theme.textMuted }]}>Points: {completion.points}</Text>
                </View>
                ...
                {completion.completedAt && (
                  <View style={styles.detailRow}>
                    <LinearGradient
                      ...
                      style={styles.detailIcon}
                    >
                      <MaterialCommunityIcons name="clock-check" size={12} color={theme.textMuted} />
                    </LinearGradient>
              ...
              <View style={[styles.completionFooter, { borderTopColor: theme.border }]}>
                <Text style={[styles.viewDetails, { color: theme.textSecondary }]}>Tap to view full details</Text>
...
// Styles remain exactly the same as your original (colors applied inline)
